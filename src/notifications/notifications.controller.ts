...
export class NotificationsController {
  ...
  @Get('counts')
  getCounts(@Req() req) {
    return this.notificationsService.getCounts(req.user.userId);
  }
  ...
  @Put(':id/unarchive')
  unarchive(@Req() req, @Param('id') id: string) {
    return this.notificationsService.unarchive(req.user.userId, id);
  }
